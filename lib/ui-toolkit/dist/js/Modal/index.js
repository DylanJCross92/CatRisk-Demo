...
var Modal = function (_Component) {
  ...
  _createClass(Modal, [{
    ...
    value: function updateStyle() {
      ...
      var bodyIsOverflowing = (0, _isOverflowing2.default)(this.props.container && this.props.container.modalContainer || document.body);
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _extends({}, baseModalProps, {
          ...
          transition: animation ? _Fade3.default : undefined,
...
Modal.propTypes = _extends({}, _Modal2.default.propTypes, _ModalDialog2.default.propTypes, {
...
Modal.BackdropFade = function (_Fade) {
  _inherits(BackdropFade, _Fade);

  function BackdropFade() {
    _classCallCheck(this, BackdropFade);

    return _possibleConstructorReturn(this, (BackdropFade.__proto__ || Object.getPrototypeOf(BackdropFade)).apply(this, arguments));
  }

  return BackdropFade;
}(_Fade3.default);
Modal.BackdropFade.defaultProps = _extends({}, _Fade3.default.defaultProps, {
  timeout: 150
});
